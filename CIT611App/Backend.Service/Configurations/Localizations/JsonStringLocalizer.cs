...
namespace Backend.Service.Configurations.Localizations
{
    public class JsonStringLocalizer
    {
        ...
        {
            string filePath = $"{TargetPath}/Resources/{Thread.CurrentThread.CurrentCulture.Name}.json";
        ...
        {
            string relativeFilePath = $"{TargetPath}/Resources/{Thread.CurrentThread.CurrentCulture.Name}.json";
            string fullFilePath = Path.GetFullPath(relativeFilePath);
            if (File.Exists(fullFilePath))
            {
                string cacheKey = $"{TargetPath}_locale_{Thread.CurrentThread.CurrentCulture.Name}_{key}";
